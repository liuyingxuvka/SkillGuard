...
- [x] 1.1 Correct README model evidence and add v0.4.2 changelog history.
- [x] 1.2 Reconcile FlowGuard project records and CI pins to 0.65.1.
- [x] 1.3 Establish and audit observed model authority from fresh evidence.
