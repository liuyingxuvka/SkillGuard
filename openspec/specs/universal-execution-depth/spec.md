...
Define SkillGuard's fixed target-neutral supervision lifecycle for complete target-declared checks, affected-only freshness, immutable receipt consumption, transactional installation, and frozen final admission.
