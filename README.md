...
| CI definition | Windows/Linux and Python 3.10/3.12 workflow included; remote execution is a separate release check |
...
| CI 定义 | 已包含 Windows/Linux、Python 3.10/3.12 工作流；远端执行仍是独立发布检查 |
