...
_MODEL_DIR = _REPO_ROOT / ".flowguard" / "models" / "owners" / "validation_composition"
_BEHAVIOR_DIR = _REPO_ROOT / ".flowguard" / "behavior" / "owners" / "validation_composition"
for _path in (_MODEL_DIR, _BEHAVIOR_DIR):
...
def run_all() -> tuple[bool, dict[str, Any]]:
    ...
    positive = {
        ...
        "current_test_mesh_is_design_evidence_not_owner_receipt_reuse": all(
            ...
            and suite.command
            == "python .flowguard/verification/owners/validation_composition/run_checks.py --json"
