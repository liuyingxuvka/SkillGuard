...
SOURCE_MODEL_PATH = ".flowguard/models/owners/validation_composition/validation_composition_model.py"
...
def _suite(
    ...
    return TestSuiteEvidence(
        suite_id,
        command="python .flowguard/verification/owners/validation_composition/run_checks.py --json",
